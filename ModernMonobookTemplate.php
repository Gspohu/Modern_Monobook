...
* @ingroup Skins
*/
class ModernMonobookTemplate extends BaseTemplate {

	/**
	* Template filter callback for ModernMonobook skin.
	...
	if ( count( $validFooterIcons ) + count( $validFooterLinks ) > 0 ) {
		...
		<footer role="contentinfo"<?php $this->html( 'userlangattributes' ) ?>>
				...
				if ( count( $validFooterLinks ) > 0 ) {
					...
					<div class="subLinksContainer">
						<div class="subLinks">
							...
							?>
							<a href="test">Test de lien footer</a>
							<a href="test">Test de lien footer</a>
							<a href="test">Test de lien footer</a>
							<a href="test">Test de lien footer</a>
							<a href="test">Test de lien footer</a>
			...
			<div class="footerContainer2">
				...
				{
					?>
					<div class="f-<?php echo htmlspecialchars( $blockName ); ?>ico">
				...
				?>
					Test de footer footer legal <br><br>
					<?php $this->html( $pageDate ); ?>
					<div class="iconLegalFooter"></div>
				</div>
			</div>
		</footer>
			...
			* Shared between ModernMonobook and Modern
			*/
			function cactions() {
				?>
			...
			<div class="portlet" id="p-tb" role="navigation">
				...
				<div class="pBody">
					<ul>
						...
						Hooks::run( 'ModernMonobookTemplateToolboxEnd', array( &$this ) );
